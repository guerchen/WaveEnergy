...
st.image(Image.open("D:\All\Projetos\Streamlit waves\Power.png"))
...
st.image(Image.open("D:\All\Projetos\Streamlit waves\Wakemodel.png"))

st.markdown("The equation coefficients are as follows:")

st.image(Image.open("D:\All\Projetos\Streamlit waves\coef.png"))
